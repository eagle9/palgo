"""
not quite get it yet but this one is not that important
#
#	Statement:
...
check out the sorting process in the table, which is easier to understand
iParent     = floor((i-1) / 2)
  iLeftChild  = 2*i + 1
  iRightChild = 2*i + 2
"""
...
def moveDown( aList, first, last ):
    #largest is the left child of first
	largest = 2 * first + 1
	while largest <= last:
