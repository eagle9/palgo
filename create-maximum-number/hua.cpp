...
Runtime: 32 ms, faster than 97.96% of C++ online submissions for Create Maximum Number.
Memory Usage: 14.6 MB, less than 84.21% of C++ online submissions for Create Maximum Number.
