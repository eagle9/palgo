/*
huahua bfs
Runtime: 32 ms, faster than 92.31% of C++ online submissions for Shortest Path to Get All Keys.
Memory Usage: 13.2 MB, less than 73.33% of C++ online submissions for Shortest Path to Get All Keys.
