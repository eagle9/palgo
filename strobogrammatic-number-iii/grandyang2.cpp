/*
Runtime: 64 ms, faster than 62.96% of C++ online submissions for Strobogrammatic Number III.
Memory Usage: 8.3 MB, less than 88.24% of C++ online submissions for Strobogrammatic Number III.
grandyang idea2, to undrstand
*/
class Solution {
public:
