...
Runtime: 36 ms, faster than 54.95% of C++ online submissions for Maximum Sum of 3 Non-Overlapping Subarrays.
Memory Usage: 13.1 MB, less than 44.07% of C++ online submissions for Maximum Sum of 3 Non-Overlapping Subarrays.
*/
class Solution {
public:
