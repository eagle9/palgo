/*
Runtime: 52 ms, faster than 87.50% of C++ online submissions for Optimal Account Balancing.
Memory Usage: 4.8 MB, less than 1.28% of C++ online submissions for Optimal Account Balancing.

grandyang hash table and dfs
*/
class Solution {
public:
