...
public class Stack {
    private Queue<Integer> Q1 = new LinkedList<>(); //Q1 is the main queue accepting push and track the last element 
    ...
    void pop() {
        ...
        top();
        Q1.poll();
        //swap Q1 and Q2, Q1 remains to be the queue accepting push
