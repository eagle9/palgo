/*
Runtime: 8 ms, faster than 100.00% of C++ online submissions for Alien Dictionary.
Memory Usage: 5.7 MB, less than 0.81% of C++ online submissions for Alien Dictionary.
grandyang bfs
*/
class Solution {
public:
