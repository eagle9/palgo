/*
huahua c++
Runtime: 12 ms, faster than 100.00% of C++ online submissions for Parse Lisp Expression.
Memory Usage: 11.1 MB, less than 0.00% of C++ online submissions for Parse Lisp Expression.
