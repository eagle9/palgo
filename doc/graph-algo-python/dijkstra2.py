...
def Dijkstra(G,start,end=None):
  ...
  "Dijkstra: found better path to already-final vertex"
            elif w not in Q or vwLength < Q[w]: #w is final and 
                hq.heappush(Q,(vwLength,w))
                P[w] = v
...
if __name__ == '__main__':
    ...
    if path == ['s', 'x', 'u', 'v']: print "correct algorithm design"
    else: "wrong algorithm design"
    print path
    prev = None
    len = 0
    for v in path:
