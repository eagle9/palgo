...
#         self.left = None
#         self.right = None
# https://github.com/kamyu104/LeetCode/blob/master/Python/minimum-absolute-difference-in-bst.py
...
class Solution(object):
    def getMinimumDifference(self, root):
        ...
        :rtype: int
        """
        #root is the node to be examined
        #prev is the node   that has been examined
