/*
huahua
Runtime: 56 ms, faster than 55.71% of C++ online submissions for Shortest Bridge.
Memory Usage: 16.9 MB, less than 50.00% of C++ online submissions for Shortest Bridge.
*/
class Solution {
public:
