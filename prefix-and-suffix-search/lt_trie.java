//lt trie 
/*
Runtime: 302 ms, faster than 74.96% of Java online submissions for Prefix and Suffix Search.
Memory Usage: 89.6 MB, less than 68.71% of Java online submissions for Prefix and Suffix Search.
*/
class WordFilter {
    TrieNode trie;
